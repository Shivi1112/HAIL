...
#      notes_df = notes_df[notes_df.TEXT == "TEXT"]
    notes_df = notes_df[["HADM_ID",  "SUBJECT_ID", "CHARTTIME"]]
...
def save_mimic_split_patient_wise(df, label_column, save_dir, task_name, seed, column_list=None):
    ...
    print(os.path.abspath("../tasks/mimic_train.csv"))

    # Load prebuilt MIMIC patient splits
    data_split = {"train": pd.read_csv("../mimic_train.csv"),
